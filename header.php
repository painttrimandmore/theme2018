...
<html class="no-js" <?php language_attributes(); ?> >
	...
	<header class="site-header" role="banner" data-sticky-container>
		<div class="sticky-top-bar" data-sticky data-options="anchor: page; marginTop: <?php echo ( is_admin_bar_showing() ) ? '2' : '0'; ?>; stickyOn: small;">
						...
						<div class="title-bar-left">
							<span class="site-mobile-title title-bar-title show-for-small-only">
								<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
									...
									<div class="svg-container logo">
										<?php echo file_get_contents( THEME_DIR . '/dist/assets/images/roof-and-name.jpg.svg' ); ?>
									</div>
